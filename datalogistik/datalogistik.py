...
def main():
    ...
    #     cached_dataset_path = util.generate_dataset(dataset, argument_info)
    # else:
    #     cached_dataset_path = util.download_dataset(dataset)
    ...
    # else:
    #     compression = dataset.get("file-compression")
    # # Convert if necessary
    # if (dataset["format"] != argument_info.format) or (
    #     dataset["partitioning-nrows"] != argument_info.partition_max_rows
