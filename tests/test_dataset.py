...
multi_file_listing = [
    {
        ...
        "rel_path": str(pathlib.Path("taxi_2013/taxi_2013_1.csv.gz")),
    },
    {
        "file_size": 5317,
        "md5": "1f31a9592ef7c01ab7798bf99ec40cbf",
        "rel_path": str(pathlib.Path("taxi_2013/taxi_2013_10.csv.gz")),
    },
    {
        "file_size": 4418,
        "md5": "2944d4805b03490cf835f5df10ecf818",
        "rel_path": str(pathlib.Path("taxi_2013/taxi_2013_11.csv.gz")),
    },
    {
        "file_size": 4506,
        "md5": "46cf71e81adf8ba04f3a49d4c89e11b6",
        "rel_path": str(pathlib.Path("taxi_2013/taxi_2013_12.csv.gz")),
    },
    {
        "file_size": 5017,
        "md5": "8a543d62f9095cb1380322484efa75af",
        "rel_path": str(pathlib.Path("taxi_2013/taxi_2013_2.csv.gz")),
    },
    {
        "file_size": 5265,
        "md5": "3fc980b571f685c2cd696d6ce2ecf26c",
        "rel_path": str(pathlib.Path("taxi_2013/taxi_2013_3.csv.gz")),
    },
    {
        "file_size": 5875,
        "md5": "f8049f0d6ac73116e867a327a51898e9",
        "rel_path": str(pathlib.Path("taxi_2013/taxi_2013_4.csv.gz")),
    },
    {
        "file_size": 4508,
        "md5": "9d91300d1fd30e0ba48e0603da5a1128",
        "rel_path": str(pathlib.Path("taxi_2013/taxi_2013_5.csv.gz")),
    },
    {
        "file_size": 4054,
        "md5": "e10ab9eb7aef2475ae929901a4c80295",
        "rel_path": str(pathlib.Path("taxi_2013/taxi_2013_6.csv.gz")),
    },
    {
        "file_size": 4647,
        "md5": "a05d59851464f30c738eb13c2fcad472",
        "rel_path": str(pathlib.Path("taxi_2013/taxi_2013_7.csv.gz")),
    },
    {
        "file_size": 3732,
        "md5": "6d07d420b3df851d38b84d59a9ffcb41",
        "rel_path": str(pathlib.Path("taxi_2013/taxi_2013_8.csv.gz")),
    },
    {
        "file_size": 4603,
        "md5": "e691c1fc5ba3aeb13da86cf54d91db2d",
        "rel_path": str(pathlib.Path("taxi_2013/taxi_2013_9.csv.gz")),
    },
]
